...
<body>
	<c:form action="saveTeacher" modelAttribute="teacher">
		...
		<c:input path="teacherId" placeholder="Enter techer id"/><br><br>
		
		<c:label path="teacherName">Teacher Name</c:label>
		<c:input path="teacherName" placeholder="Enter techer name"/><br><br>
		
		<c:label path="teacherEmail">Teacher Email</c:label>
		<c:input path="teacherEmail" placeholder="Enter techer email"/><br><br>
